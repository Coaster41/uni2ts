...
class MoiraiePretrain(L.LightningModule):
    ...
    def __init__(
        ...
        beta1: float = 0.9,
        beta2: float = 0.98,
        loss_func: PackedQuantileLoss = PackedQuantileEncoderMAELoss(),
    ...
    def forward(
        ...
        :return: quantile preds, scaled_target
        """
    ...
    def _extract_next_step_forecast(
        ...
        Not much is actually happening here this is an artifact from decoder model
        """
        ...
        # (*batch, seq_len, patch_size)

        # Align target: position t's prediction targets position t (because encoder) so they're the same
        target_aligned = scaled_target
